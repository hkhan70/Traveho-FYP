/*Downloaded from https://www.codeseek.co/wikiki/bulma-carousel-mXbNjN 
  CAROUSEL JS */
...
/* MODAL SIGNUP */
document.querySelector("#vendorsignup").addEventListener('click',(e)=>{
  document.querySelector('#signup').classList.toggle('is-active');
})
...
/* MODAL LOGIN */
document.querySelector("#vendorlogin").addEventListener('click',(e)=>{
...
/* MODAL BOOKING */
document.querySelector("#orderbooking").addEventListener('click',(e)=>{
  document.querySelector('#booking').classList.toggle('is-active');
})
document.querySelector("#finish").addEventListener('click',(e)=>{
  document.querySelector('#booking').classList.remove('is-active');
})
/* MODAL BOOKING END */

/* ADMIN PANEL MODAL*/
document.querySelector("#addpackage").addEventListener('click',(e)=>{
  document.querySelector('#packageform').classList.toggle('is-active');
  })
  document.querySelector("#complete").addEventListener('click',(e)=>{
  document.querySelector('#packageform').classList.remove('is-active');
  }) 
